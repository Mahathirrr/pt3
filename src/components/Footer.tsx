          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-primary-400">Mahathir</span>
              </h3>
              <p className="text-gray-300 mb-4">
                Tech Enthusiast, bersemangat dalam menciptakan solusi yang
                efisien dan terukur.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Jangan ragu untuk menghubungi saya untuk kolaborasi atau sekadar
                ngobrol.
              </p>
              <motion.a
        ...
        <div className="py-6 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-400 text-sm flex items-center mt-2 md:mt-0">
              Dibuat dengan <Heart size={16} className="mx-1 text-red-500" /> di
              Aceh, Indonesia
            </p>
          </div>
        </div>
